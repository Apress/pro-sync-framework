...
namespace CustomProvider
{
    ...
    public partial class DBSyncForm : Form
    {
        ...
        //Sync providers
        MyDbSyncProvider providerA;
        MyDbSyncProvider providerB;
        MyDbSyncProvider providerC;
        ...
        private void SyncForm_Load(object sender, EventArgs e)
        {
            ...
            providerA = new MyDbSyncProvider(replicaA, providerA_ReplicaCon, providerAMetadata);
            ...
            providerB = new MyDbSyncProvider(replicaB, providerB_ReplicaCon, providerBMetadata);
            ...
            providerC = new MyDbSyncProvider(replicaC, providerC_ReplicaCon, providerCMetadata);
        ...
        private void Synchronize(MyDbSyncProvider sourceProvider, MyDbSyncProvider destProvider)
        {
            try
            {
